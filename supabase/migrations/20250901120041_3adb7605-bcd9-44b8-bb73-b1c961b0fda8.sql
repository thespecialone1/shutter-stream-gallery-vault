-- Complete security fixes - Part 2: Create secure view and enhanced functions
...
-- Add data masking for sensitive profile updates
...
BEGIN
  ...
  PERFORM public.log_security_event(
    ...
    json_build_object(
      'user_id', auth.uid(),
      'fields_updated', json_build_array('full_name', 'email', 
