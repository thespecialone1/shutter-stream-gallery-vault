-- Ensure pgcrypto is available and callable from our functions
CREATE EXTENSION IF NOT EXISTS pgcrypto WITH SCHEMA extensions;

-- hash_password: uses digest and gen_random_uuid
...
-- verify_password: uses crypt and digest
...
-- hash_password_secure: uses gen_random_bytes and digest
...
-- create_secure_share_link: uses digest
...
-- create_gallery_invite: uses digest
...
-- validate_gallery_invite: uses digest
...
-- validate_secure_share_link: uses digest
...
-- create_session_from_share_link: uses digest
